...
import (
	...
	"github.com/shashaankramesh/opguard/internal/driver"
	"github.com/shashaankramesh/opguard/internal/handlers"
...
func setupApp() (*string, error) {
	...
	dbPass := flag.String("dbpass", "shab", "database password")
	databaseName := flag.String("db", "opguarddb", "database name")
